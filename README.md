...
IMPORTANT: As mentioned above, this project was more of a learning experience and as a way for me to transfer Python neural networks to C# required by Unity; My library allows for the creation of custom neural network architectures and instead of using a Unity Plugin to allow Python ML models to run in Unity, I just put the weights and biases of the Python model into a custom C# model (seen in my Digit Recognizer project). For this reason, little UI exists for the library and for true training of models, utilizing NumPy with tensors for quick matrix operations, and Matplotlib and scikit-learn to observe the metrics of the model as it learns.
